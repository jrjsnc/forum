...
public class Topic {
	...
	/**
	 * The one to many relation with entity Comment. One topic can have more than
	 * one comments. One comment can be assign only to one topic.
	 */
	@OneToMany(mappedBy = "topic", cascade = CascadeType.PERSIST, orphanRemoval = true)
	private List<Comment> comments = new ArrayList<Comment>();

	/**
	 * The many to one relation with entity ForunUser. Foreign key is ident of user.
	 * One user cad add more topics. One topic can be added by only one user.
	 */
	...
	/**
	 * The many to many relation with entity Tag. One topic can have more tags and
	 * one tag can be added to more topics.
	 */
